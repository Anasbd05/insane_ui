...
const Hero = () => {
  return (
    <div className='bg-black  text-white relative overflow-clip py-[72px] sm:py-24 bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46ED8_82%)] '>
        <div className="absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] border bg-[radial-gradient(closest-side,#000_82%,#9560EB)] top-[calc(100%-96px)] sm:top-[calc(100%-128px)] border-[#B48CDE] left-1/2 -translate-x-1/2 rounded-[100%] bg-black "></div>
